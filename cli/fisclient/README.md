...
- Ensure that the metadata can be accessed from your ECS.
- **fisclient** will configure private DNS for your ECS.
...
- Step 1. Create a private ECS image from an **general-purpose architecture** FPGA Elastic Cloud Server.
...
- Step 4. Share the created private ECS image with user B.
...
- Step 1. Cancel the image sharing with user B.
