...
### 1.2.4 Checking Packages Dependencies
...
After the FPGA image loading and application compilation, you can go to the [otc-fpga/fp1/software/app/dpdk_app/bin](./fp1/software/app/dpdk_app/bin) directory to run user applications.
